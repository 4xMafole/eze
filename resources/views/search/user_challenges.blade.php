	...
	<body>
		<div class="navigators">
			...
			<a href="#challenges" rel="modal:open">
				<i class="fas fa-grip-vertical nav-selector-active"  style="float: right;"></i>
			</a>
		</div>
		<br>
		<div class="page" style="display: none;">
			<div class="filter">
				@if(!$challenge->isEmpty() || !$challenged->isEmpty())


					@if($challenge_user == $user_id && $user_id == Auth::id())
						<h6 class="h6">you challenged</h6>
						<br>
					@elseif($challenge_user == $user_id)
						<h6 class="h6">{{ $username[0] }} challenged</h6>
						<br>
					@endif
					...
					{{-- shows if the user has been challenged. --}}

					@if($challenged_user == $user_id && $user_id == Auth::id())
						<h6 class="h6">challenged you</h6>
						<br>
					@elseif($challenged_user == $user_id)
						<h6 class="h6">challenged {{ $username[0] }}</h6>
						<br>
					@endif

					@foreach($challenged as $challenge)
						<div class="challenges">
							<div class="row">
								{{-- user post --}}
								<div class="col-md-5">
