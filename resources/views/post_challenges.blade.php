					...
					<div class="challenges">
						<div class="row">
							...
							<div class="col-md-5">
								<div class="post" id="post">
									<div class="header" id="header">
										...
										<div class="username" userid="{{ $challenge->user }}">
											{{ $challenge->user_name }}
											@if($challenge->user != Auth::id())
												@if(auth()->user()->isFollowing($challenge->user))
													<i class="fab fa-fly flying" id="{{ $challenge->user }}"></i>
												@else
													<i class="fab fa-fly fly" id="{{ $challenge->user }}"></i>
												@endif
											@endif
										</div>
									</div>
							...
							<div class="col-md2">
								...
								<div class="lit user-lit-btn" id="litt" >
							...
							<div class="col-md-5">
								<div class="post" id="post">
									<div class="header" id="header">
										...
										<div class="username" challengerid="{{ $challenge->challenger }}">
											{{ $challenge->challenger_name }}
											@if($challenge->challenger != Auth::id())
												@if(auth()->user()->isFollowing($challenge->challenger))
													<i class="fab fa-fly flying" id="{{ $challenge->challenger }}"></i>
												@else
													<i class="fab fa-fly fly" id="{{ $challenge->challenger }}"></i>
												@endif
											@endif
										</div>
									</div>
					...
					<div class="row">
						...
						<div class="col-md-5">
							<div class="post">
								<div class="header">
									<div class="card-avatar">
										<span id="avatar" class="content-placeholder"></span>
										<span class="content-placeholder" style="height: 1em; width: 3em; margin-bottom: 20px; border-radius: 5em;"></span>
									</div>
								</div>
								<div class="photo">
									<span id="photo" class="content-placeholder" style="box-shadow: none;"></span>
								</div>
							</div>
						</div>
						<div class="col-md2">
							<span class="content-placeholder" style="border-radius: 5em; margin-top: 29em; height: 2em; width: 125px;"></span>
						</div>
						{{-- challenger post --}}
						<div class="col-md-5">
							<div class="post">
