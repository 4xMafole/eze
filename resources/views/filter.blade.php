...
<head>
	...
	<title>Filter - Decide what's quality</title>
	...
	<div class="page-placeholder">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="setting">
						<span id="pencil-placeholder" class="content-placeholder" style="height: 16px; width: 16px;  border-radius: 1em;"></span>
						<span id="cog-placeholder" class="content-placeholder" style="height: 16px; width: 16px;  border-radius: 1em; margin-left: 80%;"></span>
					</div>
			...
			<div class="container">
				<div class="row">
					...
					{{-- All notifications comes here --}}
					<div class="col-md-3">
						<div class="side-lit-placeholder content-placeholder" style="box-shadow: none; height: 38em; width: 100%; border-top-left-radius: 5px; border-top-right-radius: 5px; padding: 10px;">
						</div>
					</div>
