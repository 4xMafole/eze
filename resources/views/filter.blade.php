							...
							<div class="row">
									...
									<div class="post">
										<div class="header">
											<div class="card-avatar">
												<img id="avatar" src="img/c.jpg" alt="">
											</div>
											<div class="username">Hassan Masinde</div>
										</div>
										<div class="photo">
											<img src="img/c.jpg" alt="" id="photo">
										</div>
										<div class="lit">
											<i id="lit" class="fas fa-tint"></i>
											<span id="lit-count">12.1k</span>
										</div>
									</div>
								</div>
								<div class="col-md2">
								...
								<div class="col-md-5">
									<div class="post">
										<div class="header">
											<div class="card-avatar">
												<img id="avatar" src="img/f.jpg" alt="">
											</div>
											<div class="username">Warren Buffet</div>
										</div>
										<div class="photo">
											<img id="photo" src="img/f.jpg" alt="">
										</div>
										<div class="lit">
											<i id="lit" class="fas fa-tint"></i>
											<span id="lit-count">1000</span>
										</div>
									</div>
								</div>
							</div>
