...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4">
				<div class="nav">
						<a href="filter.html"><i class="fas fa-compass" id="i"></i></a>
						<a href="explore.html"><i class="fas fa-globe-africa" id="i"></i></a>
						<a href="profile.html"><i class="fas fa-user i" id="i"></i></a>
				</div>
			</div>
